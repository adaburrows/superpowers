...
#define FFTW_CC "arm-linux-androideabi-gcc --sysroot=/opt/android-ndk-r8b/platforms/android-14/arch-arm/ -std=gnu99 -march=armv7-a -mfloat-abi=softfp -mfpu=neon"
